...
(function(){
    ...
    *   @author:      jamie sellars (@goingsideways on github)
    **/
    angular.module('app').controller('typeController', ['$scope','settingsTypesService','alertService', '$stateParams', '$injector', function($scope,settingsTypesService,alertService,$stateParams,$injector){
