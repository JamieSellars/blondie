...
(function(){
        ...
        vm.categories = {
          ...
          create: function(){
            ...
            settingsCategoriesService.save(vm.categories.formdata).then(function success(d){
                alertService('success', 'Category Created!', d.data.name + ' has been created.');
    ...
    *   @author:      jamie sellars (@goingsideways on github)
    **/
    angular.module('app').controller('categorySettingsController', ['$scope','settingsCategoriesService','alertService', '$stateParams', '$injector', function($scope,settingsCategoriesService,alertService,$stateParams,$injector){
